            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Edit Obat</h3>
                        <p class="text-gray-600">Perbarui informasi obat sesuai kebutuhan</p>
                        <div class="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3">
                            <p class="text-amber-800 text-sm">
                                <i class="fas fa-info-circle mr-1"></i>
                                Mengedit: <strong id="currentDoctorName">{{ $obat->nama_obat }}</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.obat.update', $obat->id) }}" id="formEditobat" class="space-y-6">
                        @csrf
                        @method('PATCH')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="nama_obat" name="nama_obat" required
                                    ...
                                    placeholder="Paracetamol" value="{{ old('nama_obat', $obat->nama_obat) }}">
                            </div>
                            <!-- Kemasan -->
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" id="kemasan" name="kemasan" required
                                            ...
                                            placeholder="Sachet" value="{{ old('kemasan', $obat->kemasan) }}">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" id="harga" name="harga" required
                                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-400 pr-12"
                                            placeholder="10000" value="{{ old('harga', $obat->harga) }}">
                                    </div>
                                </div>
                            </div>
