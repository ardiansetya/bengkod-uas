            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Tambah Poli Baru</h3>
                        <p class="text-gray-600">Lengkapi informasi poli untuk menambahkan ke sistem</p>
                    </div>

                    <!-- Form -->
                    <form action="{{ route('admin.poli.store') }}" method="POST" id="formTambahpoli"
                        class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Nama poli -->
                            <div class="md:col-span-2">
                                <label for="nama_poli" class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="keterangan" name="keterangan" required
                                        ...
                                        placeholder="Pelayanan kesehatan umum">
                                    <button type="button"
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                            ...
                            <form action="{{ route('admin.poli.store') }}" method="POST" id="formSimpanpoli">
                                @csrf
                                <button type="submit"
